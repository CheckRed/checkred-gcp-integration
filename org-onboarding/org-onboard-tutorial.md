...
If the command returns a version (e.g. Terraform v1.15.8), your environment is ready — proceed to "Enable IAM API". If it returns "command not found" or install instructions, Terraform is not installed. Run the commands below to install it into your home directory:
